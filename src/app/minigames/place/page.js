...
const PALETTE = [
  ...
  { hex: '#FFB000', name: 'Oro Viejo' },
  { hex: '#ffd900', name: 'Amarillo' },
  { hex: '#3E442C', name: 'Verde Oliva' },
  { hex: '#1F5B4D', name: 'Verde Menta Oscuro' },
  ...
  { hex: '#3a3aff', name: 'Azul Aqua' },
  { hex: '#0000ff', name: 'Azul' },
  { hex: '#2450A4', name: 'Azul Real' },
  { hex: '#2D4150', name: 'Azul Pizarra' },
  { hex: '#0F1B33', name: 'Azul Profundo' },
  { hex: '#3B2147', name: 'Violeta Profundo' },
  ...
  { hex: '#c58e97', name: 'Rosa marron' },
  { hex: '#B8697F', name: 'Rosa Malva' },
  { hex: '#ff78b7', name: 'Rosa' },
  { hex: '#ff37b2', name: 'Rosa Fucsia' },
  { hex: '#ff1878', name: 'Magenta' },
  { hex: '#EEE6DE', name: 'Blanco Hueso' },
  { hex: '#F5F0DC', name: 'Blanco Crema' },
  { hex: '#EEC6B4', name: 'Rosa Albaricoque' },
  { hex: '#ffcea2', name: 'Piel Pastel' },
  { hex: '#ffaa5f', name: 'Piel naranja' },
  { hex: '#9C6926', name: 'Marrón' },
  { hex: '#5c3e16', name: 'Café Oscuro' },
  { hex: '#703314', name: 'Marrón Rojizo' },
  { hex: '#A44A3F', name: 'Terracota' },
